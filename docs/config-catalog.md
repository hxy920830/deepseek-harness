...
- `@deepseek-ai/dsh-api-workspace-controller` — requires `sessionQuery` · `typert` · `workspaceRegistry` ([`packages/api/workspace-controller/src/index.ts`](../packages/api/workspace-controller/src/index.ts))
