...
export const en = {
  ...
  capabilitiesFromProvider: 'Capability provider',
  capabilitiesFromModel: 'Capability model',
  capabilitiesFromNone: 'Not selected',
  capabilitiesFromLoading: 'Loading models…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  capabilitiesFromProvider: '能力来源提供方',
  capabilitiesFromModel: '能力来源模型',
  capabilitiesFromNone: '未选择',
  capabilitiesFromLoading: '正在加载模型…',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
