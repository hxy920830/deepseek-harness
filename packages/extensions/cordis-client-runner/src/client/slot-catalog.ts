...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop CloseBehaviorRow id \'desktop-close-behavior\'',
      'client-ui-desktop SessionLogDirRow id \'desktop-session-log-dir\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace ArchivedSessionsSettingsSection id \'archived-sessions\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-desktop CloseDialog id \'desktop-close-dialog\'',
    ],
    replaceRisk: 'none',
