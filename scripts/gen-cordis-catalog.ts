...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  desktopSessionFiles: 'client-side Tauri-only Session log file controller — packages/client/ui-desktop/README.md owns the API',
  ...
  workspaceSessionOwner: 'host-only Session release callback — packages/workspace/workspace/README.md owns the deletion lifecycle',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionPersistenceDeleteResult: 'persistence.md',
  ...
  WorkspaceArchivedSessionRequest: 'workspace.md',
  WorkspaceArchivedSessionsValue: 'workspace.md',
